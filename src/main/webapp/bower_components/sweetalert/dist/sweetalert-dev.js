...
sweetAlert.resetInputError = swal.resetInputError = function (event) {
  ...
  var $uibModal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
...
var handleKeyDown = function handleKeyDown(event, params, modal) {
  ...
  var $cancelButton = modal.querySelector('button.cancel');
  var $uibModalButtons = modal.querySelectorAll('button[tabindex]');
  ...
  for (var i = 0; i < $uibModalButtons.length; i++) {
    if ($targetElement === $uibModalButtons[i]) {
      btnIndex = i;
      break;
    }
  }
  ...
  if (keyCode === 9) {
    ...
    if (btnIndex === -1) {
      ...
      if (btnIndex === $uibModalButtons.length - 1) {
        $targetElement = $uibModalButtons[0];
      } else {
        $targetElement = $uibModalButtons[btnIndex + 1];
      }
    }
...
var openModal = function openModal(callback) {
  ...
  _removeClass$getTopMargin$fadeIn$show$addClass.show($uibModal);
  _removeClass$getTopMargin$fadeIn$show$addClass.addClass($uibModal, 'showSweetAlert');
  _removeClass$getTopMargin$fadeIn$show$addClass.removeClass($uibModal, 'hideSweetAlert');
  ...
  setTimeout(function () {
    _removeClass$getTopMargin$fadeIn$show$addClass.addClass($uibModal, 'visible');
  }, 500);
...
var resetInput = function resetInput() {
  ...
  _removeClass$getTopMargin$fadeIn$show$addClass.removeClass($uibModal, 'show-input');
...
var fixVerticalPosition = function fixVerticalPosition() {
  var $uibModal = getModal();
  $uibModal.style.marginTop = _removeClass$getTopMargin$fadeIn$show$addClass.getTopMargin(getModal());
};
